    ...
    <section className="px-[5%] py-16 font-quicksand">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-700 text-base md:text-lg leading-relaxed">
          ...
          <span className="text-blue-600 underline decoration-2 underline-offset-4">quicker access</span> to the DOP. The goal was to <span className="text-red-500">build</span> a specialized <span className="text-red-500">chatbot</span> to make finding information in the DOP document much easier and faster.
        </p>
      </div>
    </section>
  );
